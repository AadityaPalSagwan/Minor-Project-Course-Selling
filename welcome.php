  ...
  <div class="courses">
    <div class="course-card">
      ...
      <div class="course-details">
        ...
        <button><a href="courses.php">Enroll Now</a></button>
      </div>
    </div>
    <div class="course-card">
      <img src="./assets/image/pepsheco-student.png.webp" alt="Course Image">
      <div class="course-details">
        <h2>Dtat Analytics</h2>
        <p>Learn HTML, CSS, JavaScript and more to build modern websites and web applications.</p>
        <div class="course-meta">
        ...
        <button><a href="courses1.php">Enroll Now</a></button>
      </div>
    </div>
    <div class="course-card">
      <img src="./assets/image/pepsheco-student.png.webp" alt="Course Image">
      <div class="course-details">
        ...
        <button><a href="courses2.php">Enroll Now</a></button>
      </div>
    </div>
  </div>
